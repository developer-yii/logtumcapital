...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "address" => "dirección",
        "consetitutive_act_document" => "documento de acta constitutiva",
        "ine_document" => "documento INE",
        "company" => "empresa",
        "first_name" => "primer nombre",
        "middle_name" => "segundo nombre",
        "last_name" => "apellido",
        "confirm_password" => "confirmar contraseña",
        "ioweyou_expiry_date" => "fecha de vencimiento de pagaré",
        "ioweyou_document" => "documento de pagaré",
        "authorized_credit_limit" => "límite de crédito autorizado",
        ...
        "interest_earnings" => "ganancias de interés",
        "total_amount" => "monto total",
        "investment_contract" => "contrato de inversión",
        "note" => "nota",
