@php
  $labelMain = __("translation.Company Admin Details");
  $label = __("translation.Company Admin");
@endphp
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <table id="company_admins_table" class="table site_table w-100 nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('companyadmin.store') }}" method="POST" id="add-form">
            @csrf
...
@push('js')
    <script>
        ...
        var deleteCompanyAdminConfirmMsg = '{{ __("translation.All details related to this will be permanently deleted. Are you sure you want to proceed with the deletion?")}}';
    </script>
    <script src="{{asset('/')}}backend/js/vendor/jquery.dataTables.min.js"></script>
    <script src="{{asset('/')}}backend/js/vendor/dataTables.bootstrap5.js"></script>
    <script src="{{asset('/')}}backend/page-js/company_admin.js"></script>
@endpush
